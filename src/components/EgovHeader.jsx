    ...
    return (
        ...
        <div className="header">
            <div className="inner">
                ...
                <h1 className="logo">
                    <Link to={URL.MAIN} className="w"><img src="/assets/images/logo_tr_w_4.png" alt="TIREPORT 사내업무시스템" /></Link>
                    <Link to={URL.MAIN} className="m"><img src="/assets/images/logo_tr_m.png" alt="TIREPORT 사내업무시스템" /></Link>
                </h1>

                <div className="gnb">
                    <h2 className="blind">주메뉴</h2>
                    <ul>
                        <li><NavLink to={URL.ABOUT} className={({ isActive }) => (isActive ? "cur" : "")}>티아이리포트</NavLink></li>
                        <li><NavLink to={URL.INTRO} className={({ isActive }) => (isActive ? "cur" : "")}>주간업무보고</NavLink></li>
                        <li><NavLink to={URL.SUPPORT} className={({ isActive }) => (isActive ? "cur" : "")}>정기반영목록</NavLink></li>
                        <li><NavLink to={URL.INFORM} className={({ isActive }) => (isActive ? "cur" : "")}>공지사항</NavLink></li>

                        {sessionUserSe ==='USR' &&
                            <li><NavLink to={URL.ADMIN} className={({ isActive }) => (isActive ? "cur" : "")}>관리자</NavLink></li>
                        }
                    </ul>
                </div>
            ...
            <div className="all_menu WEB closed">
                ...
                <div className="inner">
                    ...
                    <div className="col">
                        <h3>주간업무보고</h3>
                        <ul>
                            <li><NavLink to={URL.INTRO_WORKS} className={({ isActive }) => (isActive ? "cur" : "")}>주간보고관리</NavLink></li>
                            <li><NavLink to={URL.INTRO_SERVICE} className={({ isActive }) => (isActive ? "cur" : "")}>일정관리</NavLink></li>
                        </ul>
                    </div>
                    <div className="col">
                        <h3>정기반영목록</h3>
                        <ul>
                            <li><NavLink to={URL.SUPPORT_DOWNLOAD} className={({ isActive }) => (isActive ? "cur" : "")}>개인목로관리</NavLink></li>
                            <li><NavLink to={URL.SUPPORT_QNA} className={({ isActive }) => (isActive ? "cur" : "")}>취합목록관리</NavLink></li>
                            <li><NavLink to={URL.SUPPORT_APPLY} className={({ isActive }) => (isActive ? "cur" : "")}>알림서비스</NavLink></li>
                        </ul>
                    </div>
                    <div className="col">
                        <h3>공지사항</h3>
