  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path={URL.ADMIN_MENU_CREATE} element={<EgovAdminMenuEdit mode={CODE.MODE_CREATE} />} />
        <Route path={URL.ADMIN_MENU_MODIFY} element={<EgovAdminMenuEdit mode={CODE.MODE_MODIFY} />} />
