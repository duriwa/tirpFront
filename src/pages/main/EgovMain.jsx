            ...
            <div className="c_wrap">
                <div className="colbox">
                    <div className="left_col">
                        <img src="/assets/images/img_simple_main_tr.png" alt="단순 홈페이지 전자정부 표준프레임워크의 경량환경 내부업무에 대한 최신 정보와 기술을 제공하고 있습니다." />
                    </div>
                    ...
                    <div className="right_col">
                        ...
                        <div className="banner">
                            ...
                            <Link to={URL.ABOUT} className="bn2">
                                <strong>자유게시판</strong>
                                <span>자유롭게 자기 생각을<br />표현해보세요.</span>
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="banner_bot">
                    ...
                    <div className="b2">
                        <div>
                            <h2>주간업무보고</h2>
                            <p>한 주간의 업무 보고서를 작성하는 서비스입니다.<br />
                                <br />
                                </p>
                        </div>
