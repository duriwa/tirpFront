...
function MenuList(props) {
    ...
    console.log("[Start] MenuList ------------------------------");
    console.log("MenuList [props] : ", props);

    const location = useLocation();
    console.log("MenuList [location] : ", location);
    ...
    const retrieveList = useCallback((srchCnd) => {
        console.groupCollapsed("MenuList.retrieveList()");
        ...
        console.groupEnd("MenuList.retrieveList()");
    ...
    console.log("------------------------------MenuList [End]");
    console.groupEnd("MenuList");
    return (
