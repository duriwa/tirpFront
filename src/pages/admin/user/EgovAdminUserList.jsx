...
function UserMngList(props) {
    console.group("UserMngList");
    console.log("[Start] UserMngList ------------------------------");
    console.log("UserMngList [props] : ", props);

    const location = useLocation();
    console.log("UserMngList [location] : ", location);
    ...
    const retrieveList = useCallback((srchCnd) => {
        console.groupCollapsed("UserMngList.retrieveList()");

        // const retrieveListURL = '/bbsMaster'+EgovNet.getQueryString(srchCnd);
        const retrieveListURL = '/userMng'+EgovNet.getQueryString(srchCnd);
        ...
        console.groupEnd("UserMngList.retrieveList()");
    ...
    console.log("------------------------------UserMngList [End]");
    console.groupEnd("UserMngList");
    return (
