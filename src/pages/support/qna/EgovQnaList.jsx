        ...
        <div className='layout'>
          ...
          <div className='contents QNA_LIST' id='contents'>
            ...
            <div className='top_tit'>
              <h1 className='tit_1'>정기반영</h1>
            </div>

            <h2 className='tit_2'>반영리스트 조회</h2>
            ...
            <div className='board_list BRD008'>
              ...
              <div className='result'>
                ...
                <Link to={URL.SUPPORT_QNA_DETAIL} className='list_item'>
                  <div>3</div>
                  <div className='al'>20241127 정기반영</div>
                  <div>홍길동</div>
                  <div>중</div>
                  <div>2024-11-27</div>
                </Link>
                <Link to={URL.SUPPORT_QNA_DETAIL} className='list_item'>
                  <div>2</div>
                  <div className='al'>20241121 정기반영</div>
                  <div>홍길동</div>
                  <div>상</div>
                  <div>2024-11-21</div>
                </Link>
                <Link to={URL.SUPPORT_QNA_DETAIL} className='list_item'>
                  <div>1</div>
                  <div className='al'>20241110 정기반영</div>
                  <div>홍길동</div>
                  <div>하</div>
                  <div>2024-11-10</div>
                </Link>
